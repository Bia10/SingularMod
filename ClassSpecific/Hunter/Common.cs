            ...
            return new PrioritySelector(
                ...
                /*new Switch<string>(ctx => trapName,
                    new SwitchArgument<string>("Freezing Trap",
                        new Action(ret => SpellManager.CastById(1499))),
                    new SwitchArgument<string>("Explosive Trap",
                        new Action(ret => SpellManager.CastById(13813))),
                    new SwitchArgument<string>("Ice Trap",
                        new Action(ret => SpellManager.CastById(13809))),
                    new SwitchArgument<string>("Snake Trap",
                        new Action(ret => SpellManager.CastById(34600)))
                    ),*/

                                new Action(ret => Lua.DoString(string.Format("CastByName(\"{0}\")", trapName))),

...
namespace Singular.Helpers
{
    internal static class Unit
    {
        ...
        public static IEnumerable<WoWPlayer> NearbyUnFriendlyPlayers
        {
            get
            {
                return ObjectManager.GetObjectsOfType<WoWPlayer>(true, true).Where(p => p.DistanceSqr <= 40 * 40 && !p.IsFriendly).ToList();
        ...
        internal static IEnumerable<WoWPartyMember> PartyMembers { get { return !StyxWoW.Me.GroupInfo.IsInRaid ? StyxWoW.Me.GroupInfo.PartyMembers : StyxWoW.Me.GroupInfo.RaidMembers; } }
        public static IEnumerable<WoWPlayer> Tanks
        {
            get
            {
                ...
                var tanks = PartyMembers.Where(p => (p.Role & WoWPartyMember.GroupRole.Tank) != 0);
        ...
        public static IEnumerable<WoWPlayer> Raids
        {
            get
            {
                var result = new List<WoWPlayer>();
        ...
        public static bool IsTank(this WoWUnit unit)
        {
            return Tanks.Any(u => u.Guid != StyxWoW.Me.Guid);
        }
        /// <summary>
